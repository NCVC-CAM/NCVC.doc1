...
　図\ref{fig:NCVCsetup.png}（p.\pageref{fig:NCVCsetup.png}）の読み込みレイヤ設定と違うのは，［原点データがないとき］の選択肢．
これをエラー以外に設定しておけば，NCVCがXY原点を補間します（図\ref{fig:NCVCsetup2.png}）．
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.8]{No2/fig/NCVCsetup2.png}
\caption{読み込みレイヤ設定2}
\label{fig:NCVCsetup2.png}
\end{figure}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\begin{figure}[H]
...
図\ref{fig:simhole.png} にシミュレーション結果を示します．
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{No2/fig/simuhole.png}
\caption{穴加工のシミュレーション画面}
\label{fig:simhole.png}
\end{figure}
